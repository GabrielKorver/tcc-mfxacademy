        ...
        <div className={Style.overlay}>
            <div className={Style.modal}>
                ...
                <div className={Style.pergunta}>
                    ...
                    <input type="text" id="pergunta" placeholder="Ex: Como implementar autenticação no React" />
                </div>
                <div className={Style.pergunta}>
                    <p><strong>Título da pergunta *</strong></p>
                    <textarea id="descricao" placeholder="Ex: Descreva sua dúvida em detalhes..."></textarea>
                </div>
                <div className={Style.pergunta}>
                    <p><strong>Tecnologias relacionadas*</strong></p>
                    <div className={Style.tecnologias}>
                        <input type="text" id="tecnologias" placeholder="Ex: React, Node.js, JavaScript" />
                        <span>
